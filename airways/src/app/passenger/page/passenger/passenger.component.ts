...
import { IDataTravel, IPersonsContact, IPersonsData } from 'src/app/redux/models/models';
import { selectAdultsCount, selectChildsCount, selectInfantsCount, selectPersonsContacts, selectPersonsData } from 'src/app/redux/selectors/booking.selectors';
import { PersonComponent } from '../../components/person/person.component';
import { ContactComponent } from '../../components/contact/contact.component';
import { setPersonData, setPersonsContact } from 'src/app/redux/actions/booking-main.actions';
...
export class PassengerComponent implements OnInit, AfterViewInit {
  ...
  getContactObject(): IPersonsContact {
    return {
      code: this.contactChild.contactForm?.get('phoneRegionControl')?.value || '',
  ...
  getPersonsDataObject(person: PersonComponent): IPersonsData {
    return {
      ...
      specialAssistance: person.personForm.get('specAssistance')?.value || undefined,
